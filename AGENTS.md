...
9. **Quality Radar (always-on)**: Setiap task WAJIB apply `.devin/rules/quality-radar.md` — 24 tipe kejanggalan (K1-K24) + pre-ship audit. Tidak peduli task type: UI, code, architecture, test, docs. Sebelum bilang "selesai", jalankan quick scan (24 pertanyaan) + deep scan (6 pertanyaan).
