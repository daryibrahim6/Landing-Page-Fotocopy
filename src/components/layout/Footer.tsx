    ...
    <>
      ...
      <footer className="relative overflow-hidden border-t border-[var(--color-border)] bg-slate-900 text-slate-300">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-slate-300">
              <li className="flex items-start gap-2">
                <svg viewBox="0 0 24 24" fill="currentColor" className="mt-0.5 size-4 shrink-0 text-slate-300" aria-hidden="true">
              ...
              <li className="flex items-start gap-2">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="mt-0.5 size-4 shrink-0 text-slate-300" aria-hidden="true">
                  <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z" />
                  <circle cx="12" cy="10" r="3" />
                </svg>
                <span className="text-slate-400">Jl. Dalang I No.45, Pengasinan, Rawalumbu, Kota Bekasi, Jawa Barat 17115</span>
              </li>
              <li className="flex items-start gap-2">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="mt-0.5 size-4 shrink-0 text-slate-300" aria-hidden="true">
                ...
                <span className="text-slate-400">Senin &ndash; Sabtu: 08.00 &ndash; 17.00 WIB</span>
              </li>
            </ul>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a
                ...
                className="inline-flex size-10 items-center justify-center rounded-full border border-slate-600 text-slate-300 transition hover:border-slate-300 hover:text-white"
              >
        ...
        <div className="relative z-10 border-t border-slate-700">
          <div className="relative mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-4 py-6 text-center text-xs text-slate-400 sm:flex-row sm:text-left sm:px-6 lg:px-8">
