  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center px-4">
      <div className="w-full max-w-md text-center">
        <div className="mx-auto mb-6 flex size-20 items-center justify-center rounded-full bg-[var(--color-bg-soft)]">
          <FileQuestion className="size-10 text-[var(--color-text-muted)]" />
        </div>
