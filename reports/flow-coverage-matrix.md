...
| `checkout-flow` | Core | Track A v2 selesai (2026-09-12) | P0 | CLEAR — 19 temuan FIXED | E2E authoring (opsional — money path, kandidat pertama) |
...
| `production-dashboard-flow` | Supporting | Track A v2 selesai (2026-09-12) | P3 | CLEAR — dibangun + 5 temuan (4 FIXED + 1 ACK) | Isi `ADMIN_USERNAME`/`ADMIN_PASSWORD`; E2E Basic Auth journey opsional |
