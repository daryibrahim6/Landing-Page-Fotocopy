...
| production-dashboard-flow | Supporting | Done (v2) | Done (v2) | N/A | N/A | N/A | N/A | N/A | BACKLOG | 2026-09-12 | Track A v2 Tahap 0+1: flow belum dibangun — audit = kontrak scope. PD-A-01 OPEN-BACKLOG (no admin UI), PD-A-03 interim visibility via env webhook, PD-A-04 build contract (auth matcher `/admin`+`/api/admin`, listOrders+pagination, status produksi terpisah), PD-A-02 dead dir, PD-A-05 ACK IDOR ringan. |
