...
| design-simulator-flow | Core | Done (v2) | Done (v2) | Belum | Done | N/A | Track B (opsional) | Track C (canvas UX) | ADA ISU | 2026-09-12 | Track A v2 Tahap 0+1: scope frozen + 10 temuan (DS-A-07 export PNG cross-browser P1, DS-A-05 estimasi harga — keputusan produk, DS-A-06 drag ghost mismatch, DS-A-03/04/08..12). Menunggu approval Tahap 2. |
