...
| design-simulator-flow | Core | Done (v2) | Done (v2) | Done | Done | N/A | Track B (opsional) | Track C (canvas UX opsional) | ADA ISU | 2026-09-12 | Track A v2 Tahap 0–2: 9 FIXED + 1 ACK (DS-A-08 MVP limit). 111/111 tests. Menunggu Tahap 3 track gate. |
